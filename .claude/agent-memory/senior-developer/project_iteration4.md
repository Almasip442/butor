...
**Kulcstechnikai döntés:** A `createAdminClient() as any` cast szükséges, mert a database.types.ts PostgrestVersion "12" formátuma nem kompatibilis a supabase-js v2.99.2 típusrendszerével update/insert/delete esetén.
